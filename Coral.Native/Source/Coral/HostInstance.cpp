...
namespace Coral {
    ...
    CoralInitStatus HostInstance::Initialize(HostSettings InSettings)
    {
        ...
        m_SupportedTargets = InSettings.SupportedTargets;
    ...
    void HostInstance::LoadCoralFunctions()
    {
        ...
        s_ManagedFunctions.GetTypeNameFptr = LoadCoralManagedFunctionPtr<GetTypeNameFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("GetTypeName"));
        s_ManagedFunctions.GetTypeNamespaceFptr = LoadCoralManagedFunctionPtr<GetTypeNamespaceFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("GetTypeNamespace"));
        ...
        s_ManagedFunctions.IsTypeClassFptr = LoadCoralManagedFunctionPtr<IsTypeClassFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("IsTypeClass"));
        s_ManagedFunctions.IsTypeInterfaceFptr = LoadCoralManagedFunctionPtr<IsTypeInterfaceFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("IsTypeInterface"));
        ...
        s_ManagedFunctions.IsTypeSealedFptr = LoadCoralManagedFunctionPtr<IsTypeSealedFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("IsTypeSealed"));
        s_ManagedFunctions.IsTypeValueTypeFptr = LoadCoralManagedFunctionPtr<IsTypeValueTypeFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("IsTypeValueType"));
        ...
        s_ManagedFunctions.GetTypeGenericArgumentFptr = LoadCoralManagedFunctionPtr<GetTypeGenericArgumentFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("GetTypeGenericArgument"));
        s_ManagedFunctions.GetTypeGenericTypeDefinitionFptr = LoadCoralManagedFunctionPtr<GetTypeGenericTypeDefinitionFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("GetTypeGenericTypeDefinition"));
        ...
        s_ManagedFunctions.GetMethodInfoByNameFptr = LoadCoralManagedFunctionPtr<GetMethodInfoByNameFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("GetMethodInfoByName"));
        s_ManagedFunctions.GetMethodInfoByNameParamCountFptr = LoadCoralManagedFunctionPtr<GetMethodInfoByNameParamCountFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("GetMethodInfoByNameParamCount"));
        s_ManagedFunctions.GetMethodInfoByNameParamTypesFptr = LoadCoralManagedFunctionPtr<GetMethodInfoByNameParamTypesFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("GetMethodInfoByNameParamTypes"));
        ...
        s_ManagedFunctions.GetPropertyInfoGetMethodFptr = LoadCoralManagedFunctionPtr<GetPropertyInfoGetMethodFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("GetPropertyInfoGetMethod"));
        s_ManagedFunctions.GetPropertyInfoSetMethodFptr = LoadCoralManagedFunctionPtr<GetPropertyInfoSetMethodFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("GetPropertyInfoSetMethod"));
        ...
        s_ManagedFunctions.InvokeDelegateFptr = LoadCoralManagedFunctionPtr<InvokeDelegateFn>(CORAL_STR("Coral.Managed.ManagedObject, Coral.Managed"), CORAL_STR("InvokeDelegate"));
        s_ManagedFunctions.InvokeDelegateRetFptr = LoadCoralManagedFunctionPtr<InvokeDelegateRetFn>(CORAL_STR("Coral.Managed.ManagedObject, Coral.Managed"), CORAL_STR("InvokeDelegateRet"));
        ...
        s_ManagedFunctions.SetPropertyValueFptr = LoadCoralManagedFunctionPtr<SetPropertyValueFn>(CORAL_STR("Coral.Managed.ManagedObject, Coral.Managed"), CORAL_STR("SetPropertyValue"));
    ...
    void* HostInstance::LoadCoralManagedFunctionPtr(UCStringView InAssemblyPath, const UCChar* InTypeName, const UCChar* InMethodName, const UCChar* InDelegateType) const
    {
        ...
        {
            std::cerr << "Failed to retrieve managed function pointer `" << StringHelper::UCCharToString(InTypeName).c_str() << "`::`" << StringHelper::UCCharToString(InMethodName).c_str() << "` from `" << StringHelper::ConvertUCToUtf8(InAssemblyPath).c_str() << "`" << std::endl;
            CORAL_VERIFY(false);
        }
